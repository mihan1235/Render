...
Cube::Cube(btCollisionShape* shape, float mass, ShaderProgram* shader_program
	...
	, glm::mat4 rotate) :Object(shape, mass,shader_program, position, texture_name, scale, rotate)
{
    ...
    glBindVertexArray(0);
    //texture=prepare_texture("data/textures/wall_yellow_01.dds");
}
...
void Cube::draw(ShaderProgram* shader_program1){
...
void Cube::set_shaders_parameters(ShaderProgram* shader_program) {
	...
	shader_program->set_uniform_vector3f("material.diffuse", glm::vec3(0.5f, 0.5f, 0.5f));
	shader_program->set_uniform_vector3f("material.specular", glm::vec3(0.0f, 0.0f, 0.0f));
	shader_program->set_uniform_float("material.shininess", 100.0f);
